...
- Name: rf08_cortes_caja.spec.ts >> RF08 - Generar Cortes de Caja >> CP-08-01: Generar reporte de corte de caja con desglose
- Location: e2e\rf08_cortes_caja.spec.ts:25:7
...
Call log:
  - waiting for getByRole('button', { name: /Realizar Corte Ahora/i }).or(locator('text=Realizar Corte Ahora').first())
