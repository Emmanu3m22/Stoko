...
- Name: rf06_registrar_venta.spec.ts >> RF06 - Registrar Venta >> CP-06-04: Confirmar la operación de la venta
- Location: e2e\rf06_registrar_venta.spec.ts:63:7
...
Call log:
  - waiting for getByRole('button', { name: /Finalizar Venta/i })
    - locator resolved to <button disabled class="w-full bg-[#4169E1] hover:bg-[#3155c7] disabled:opacity-40 disabled:cursor-not-allowed↵                     text-white font-black py-4 rounded-xl shadow-lg shadow-blue-200/50 transition-all active:scale-95 text-sm flex items-center justify-center gap-2">…</button>
...
- generic [ref=e3]:
  ...
  - main [ref=e43]:
    - generic [ref=e44]:
      - paragraph [ref=e45]: Módulo de Ventas
      - generic [ref=e47]: API conectada · localhost:8000
    - generic [ref=e50]:
      - generic [ref=e51]:
        - button "Nueva venta" [ref=e52]
        - button "Historial de ventas" [ref=e53]
      - generic [ref=e54]:
        - generic [ref=e55]:
          - generic [ref=e56]:
            - generic [ref=e57]:
              - generic [ref=e58]:
                - paragraph [ref=e59]: Punto de Venta
                - heading "Registro de Venta" [level=2] [ref=e60]
              - generic [ref=e61]: Cliente General
            - generic [ref=e62]:
              - img [ref=e64]
              - textbox "[⚡] Escanear código de barras o escribir y presionar ENTER..." [active] [ref=e66]: Producto Test
          - generic [ref=e68]:
            - img [ref=e69]
            - paragraph [ref=e71]: Carrito vacío
            - paragraph [ref=e72]: Busca o escanea un producto para comenzar
        - generic [ref=e73]:
          - generic [ref=e74]:
            ...
            - generic [ref=e77]:
              - generic [ref=e78]:
                - generic [ref=e79]: Descuentos
                - generic [ref=e80]: — $0.00
              - generic [ref=e81]:
                - generic [ref=e82]: IVA (16%)
                - generic [ref=e83]: $0.00
            - generic [ref=e84]:
              - paragraph [ref=e85]: Total a Pagar
              - paragraph [ref=e86]: $0.00
          - button "Finalizar Venta F12" [disabled] [ref=e87]:
            - img [ref=e88]
            - text: Finalizar Venta
            - generic [ref=e90]: F12
          - generic [ref=e91]:
            - button "Pausar" [ref=e92]
            - button "Último" [ref=e93]
          - button "Cancelar Transacción" [ref=e94]
```
