...
- Name: rf06_registrar_venta.spec.ts >> RF06 - Registrar Venta >> CP-06-05: Error al agregar producto sin stock
- Location: e2e\rf06_registrar_venta.spec.ts:84:7
...
Locator: locator('text=/no hay stock/i, text=/stock insuficiente/i').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/no hay stock/i, text=/stock insuficiente/i').first()
...
- main:
  ...
  - img
  - textbox "[⚡] Escanear código de barras o escribir y presionar ENTER...": Producto Sin Stock
  - img
