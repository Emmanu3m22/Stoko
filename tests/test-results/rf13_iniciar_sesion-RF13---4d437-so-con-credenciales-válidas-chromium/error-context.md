...
- Name: rf13_iniciar_sesion.spec.ts >> RF13 - Iniciar Sesión >> CP-13-01: Acceso exitoso con credenciales válidas
- Location: e2e\rf13_iniciar_sesion.spec.ts:12:7
...
Locator: locator('text=/Panel Principal/i, text=/Dashboard/i, text=/Catálogo/i').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Panel Principal/i, text=/Dashboard/i, text=/Catálogo/i').first()
